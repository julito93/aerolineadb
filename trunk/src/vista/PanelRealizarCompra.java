		...
		lista3.addMouseListener(new MouseAdapter() 
		{
			public void mouseClicked(MouseEvent evt)
			{
				...
				if(evt.getClickCount() == 2)
					JOptionPane.showMessageDialog(null, "Oprimi� dos veces el clic en " + list.getSelectedValue(), "Mensaje", JOptionPane.INFORMATION_MESSAGE);
			}
		});
		//********************************************************
			...
			if(lista1.getSelectedValue() != null && lista2.getSelectedValue() != null)
			{
				try 
				{
					...
					if(!comprador.equals("") && comprador != null && !vendedor.equals("") && vendedor != null)
					{
						...
						JOptionPane.showMessageDialog(null, "Los ID's de comprador y vendedor no son v�lidos", "ERROR", JOptionPane.ERROR_MESSAGE);
				} 
