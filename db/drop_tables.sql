...
drop table "Pasabordos" cascade constraints;
...
drop table "Pasabordo_Viaje" cascade constraints;
drop table "Viaje_Tarifa" cascade constraints;
drop table "Vuelo_Clase" cascade constraints;
